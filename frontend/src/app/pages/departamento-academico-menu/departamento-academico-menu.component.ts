...
import { SEGMENTOS_ACADEMICOS } from '../../core/segmentos-academicos';
  ...
  template: `
    <div class="dep-acad-menu">
      ...
      <div class="contenido">
        ...
        <p class="subtitulo">Elige el área para ver pendientes, sinodales y expedientes como en la vista del departamento.</p>
        <div class="cards">
          <button type="button" class="card" *ngFor="let s of segmentos" (click)="irSegmento(s.id)">
...
export class DepartamentoAcademicoMenuComponent {
  readonly segmentos = SEGMENTOS_ACADEMICOS;
